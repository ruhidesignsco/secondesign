...
// ═══════════ GALLERY DATA ═══════════
const items = [
  { id:1, cat:'frames', name:'La Hawla — لا حول ولا قوة إلا بالله', ar:'لا حول', en:'NO POWER EXCEPT THROUGH GOD', desc:'A stunning Mecca-inspired frame featuring the Kaaba with intricate Persian carpet patchwork in rich browns and golds. Adorned with the powerful dhikr in elegant Arabic calligraphy.', price:'AUD $20', priceNum:20, badge:'Best Seller', img:'mecca1', imgs:['mecca1','mecca2','mecca3'], details:{Frame:'Sleek black frame',Design:'Persian carpet patchwork + Kaaba',Size:'A4 (21×30cm)',Feature:'Hibiscus flower accent'}, c:{bg:'#3E2723',tx:'#D4A843',ac:'#B8860B'} },
  { id:2, cat:'frames', name:'Fa Inna — فإن مع العسر يسرا', ar:'فإن مع العسر', en:'WITH HARDSHIP COMES EASE', desc:'A breathtaking Al-Quds frame featuring the Dome of the Rock in brilliant blues and turquoise. Persian carpet patchwork with the Quranic verse.', price:'AUD $20', priceNum:20, badge:'Popular', img:'palestine1', imgs:['palestine1','palestine2','palestine3'], details:{Frame:'Elegant silver frame',Design:'Blue Persian patchwork + Dome of the Rock',Size:'A4 (21×30cm)',Feature:'Olive branch accent'}, c:{bg:'#2a4a6b',tx:'#F5F5F5',ac:'#D4A843'} },
...
function addToCart(id) {
  ...
  if (existing) {
    ...
    cart.push({ id: item.id, name: item.name, price: item.priceNum || 20, cat: item.cat, qty: 1 });
  }
  updateCartBadge();
